...
from engine.research_cli import (
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="运行因子组合实践研究")
...
def main() -> int:
    args = parse_args()
    run_id = args.run_id or f"run-factor-practice-{datetime.now().strftime('%Y%m%d-%H%M%S')}"
