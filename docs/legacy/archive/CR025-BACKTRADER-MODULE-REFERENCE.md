# CR025 Backtrader Module Reference 归档入口

> Canonical non-CR entry: [../reference/BACKTRADER-MODULE-REFERENCE.md](../reference/BACKTRADER-MODULE-REFERENCE.md).
