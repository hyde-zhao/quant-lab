...
|---|---|
| 状态 | proposed |
| 决策 | 使用 `QUANT_LAB_*_ROOT` 逻辑变量映射 NAS 512G hot、4T warm、14T cold，不硬编码真实挂载路径。 |
...
|---|---|
| 状态 | proposed |
| 决策 | 交易主机不挂载 full research archive，只读消费 package exchange 中的 zip、manifest、checksum、docs bundle。 |
