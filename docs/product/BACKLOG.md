...
| FU-CR161-002 | C1 multiple-testing, data-snooping and overfit evidence producer | follow-up CR | P0 | CR163 仅令 C1 raw-lineage input-ready；待 raw p-values、effective-trial method 和其他统计输入可审计后，另行授权才能使 C1 computable。 |
...
CR157 backlog refs, CR158 adapter scope, CR160 Stage 4 observation review scope, CR161/CR162 evidence availability baseline and CR163 trial-lineage instrumentation do not authorize real lake/NAS/provider/credential/QMT/gateway/runtime/simulation/paper/live/trading/broker/feed/order/reconciliation/store/catalog/registry/model registry/prediction store/publish/external framework/Git remote operations. CR160/CR161/CR163 consume existing CR155 evidence only as a fail-closed classification sample; none may create new data access, runtime authorization, historical backfill or statistical-correction claims.
