...
- 关联 CR：`CR-157` / `CR-158` / `CR-163` / `CR-164` / `CR-166` / `CR-168` / `CR-169` / `CR-170` / `CR-171`
- 当前门禁：无 active formal CR；CR171 outcomes 是已交付的决策记录，不是 Story ID，也不写入 `DEVELOPMENT-PLAN.yaml`。
