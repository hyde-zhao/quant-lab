---
handoff_id: "META-DEV-CR019-LLD-BATCH-C-2026-05-30"
from_agent: "meta-po"
to_agent: "meta-dev"
...
| Story | 文件 |
|---|---|
| CR019-S08-fallback-incident-signed-file-boundary | `process/stories/CR019-S08-fallback-incident-signed-file-boundary.md` |
| CR019-S09-deferred-capability-register | `process/stories/CR019-S09-deferred-capability-register.md` |
| CR019-S10-docs-runbook-user-manual-boundary | `process/stories/CR019-S10-docs-runbook-user-manual-boundary.md` |
...
| `docs/QMT-SIMULATION-LIVE-RUNBOOK.md` | runbook 输入边界 |
| `docs/QMT-INCIDENT-PLAYBOOK.md` | incident / fallback 输入边界 |
...
- 不得生成 CR019-S01..S07 的 LLD 或 CP5 预检。
- fallback 不得自动真实 QMT；signed file drop 仅作为人工 dry-run / fallback 边界。
- 文档不得写成“Story verified / runbook 完成即授权真实交易”。
