...
approval_result: "cp8-review-pending"
...
| 状态处理 | 用户于 2026-06-14 回复“同意，你可以推进 CR051 了”，允许 CR046 继续挂起并让 CR051 并行进入设计门禁；用户随后回复“同意”批准 CP2，CR051 进入 CP3 HLD review pending；用户在 CP3 讨论中指定项目新名 `quant-lab`；用户再次回复“同意”批准 CP3，接受 DQ-CP3-CR051-01..06；这些同意不恢复 CR046、不授权 runtime |
...
| 1.9 | `host-orchestrator` | 完成 CP8 release readiness 并发起人工终验 | CP7 PASS、release-readiness 输入 | Release context、5 份 release docs、CP8 自动预检 PASS、CP8 人工审查稿 | READY 不等于 RELEASED；不授权真实迁移、runtime、provider/lake/publish、push 或凭据读取 | 等待 CP8 approve / 修改 / reject |
