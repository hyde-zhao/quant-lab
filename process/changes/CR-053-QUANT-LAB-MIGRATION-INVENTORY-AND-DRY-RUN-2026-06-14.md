...
approval_result: "cp5-review-pending"
...
| `process/context/CP5-CR053-LLD-CONTEXT.yaml` | 新增 | N/A | capsule 文件 | ready-for-lld-design |
| `process/stories/CR053-S01-root-map-and-host-mapping-contract-LLD.md` | 新增 | N/A | LLD 文件 | cp5-review-pending |
| `process/stories/CR053-S02-repo-inventory-and-path-classification-LLD.md` | 新增 | N/A | LLD 文件 | cp5-review-pending |
| `process/stories/CR053-S03-path-reference-and-legacy-alias-dry-run-LLD.md` | 新增 | N/A | LLD 文件 | cp5-review-pending |
| `process/stories/CR053-S04-manifest-transfer-and-backup-plan-LLD.md` | 新增 | N/A | LLD 文件 | cp5-review-pending |
| `process/checkpoints/CP5-CR053-MIGRATION-INVENTORY-BATCH-A-LLD-BATCH.md` | 新增 | N/A | Decision Brief | pending-human-review |
