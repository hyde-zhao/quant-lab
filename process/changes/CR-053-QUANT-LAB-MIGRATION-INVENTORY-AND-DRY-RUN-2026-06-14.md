...
approval_result: "cp3-review-pending"
...
| `docs/design/HLD-CR053-QUANT-LAB-MIGRATION-INVENTORY-AND-DRY-RUN.md` | 新增 | N/A | 文档头部 `## 修订记录` | cp3-review-pending |
| `docs/design/ARCHITECTURE-DECISION-CR053.md` | 新增 | N/A | 文档头部 `## 修订记录` | cp3-review-pending |
| `process/context/CP3-CR053-DESIGN-CONTEXT.yaml` | 新增 | N/A | capsule 文件 | ready-for-review |
| `process/checks/CP3-CR053-HLD-CONSISTENCY.md` | 新增 | N/A | 自动预检结果 | pass |
| `process/checkpoints/CP3-CR053-HLD-REVIEW.md` | 新增 | N/A | Decision Brief | pending |
