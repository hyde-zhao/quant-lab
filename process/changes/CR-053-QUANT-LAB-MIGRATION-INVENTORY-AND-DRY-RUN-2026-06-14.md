...
approval_result: "cp2-review-pending"
...
|---|---|---|---|---|
| `process/changes/CR-051-STRATEGY-RESEARCH-LIFECYCLE-FRAMEWORK-2026-06-14.md` | 原文档更新 | 保留 CR051 原后续路线，追加 CR053 编号冲突处理和事件型候选改号说明 | `## 后续事项台账` | pending |
| `docs/research/PROJECT-IDENTITY-MIGRATION.md` | 原文档更新 | 保留 CR051 设计基线；CR053 后续追加 inventory / dry-run 结果 | `## 修订记录` | pending-after-cp2 |
| `docs/research/ARCHIVE-GOVERNANCE.md` | 原文档更新 | 保留 CR051 archive boundary；CR053 后续追加迁移前 forbidden content / artifact 分类 | `## 修订记录` | pending-after-cp2 |
| `process/STATE.md` | 原文档更新 | 保留 CR046 paused recovery point 和 CR051 closed baseline；新增 CR053 CP2 pending 状态 | `history` | draft-created |
| `process/changes/CR-INDEX.yaml` | 原文档更新 | 保留 CR046 active paused 和 CR051 closed；新增 CR053 active CP2 pending | `active_crs` | draft-created |
| `process/context/CP2-CR053-REQUIREMENT-CONTEXT.yaml` | 新增 | N/A | capsule 文件 | ready |
| `process/discussions/CP2-CR053-SCENARIO-DISCUSSION-LOG.md` | 新增 | N/A | 讨论日志 | ready |
| `process/checks/CP2-CR053-REQUIREMENTS-BASELINE.md` | 新增 | N/A | 自动预检结果 | pass |
| `process/checkpoints/CP2-CR053-REQUIREMENTS-BASELINE.md` | 新增 | N/A | Decision Brief | pending |
...
|---|---|---|---|---|---|---|
| 1 | `host-orchestrator` | 创建 CR053 与 CP2 门禁 | 用户回复“cr053”、CR051 CP8 closed、STATE / CR-INDEX | 正式 CR、context、discussion、CP2 auto check、CP2 checkpoint | 不执行真实迁移 | 等待 CP2 approve / 修改 / reject |
