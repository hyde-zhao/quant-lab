...
- status: `PASS`
- run_id: `run-chapter3-empirical-smoke-2000-2001`
...
- factor_panel: `reports/chapter3_factor_panel/run-chapter3-empirical-smoke-2000-2001/factor_panel.parquet`
- manifest: `reports/chapter3_factor_panel/run-chapter3-empirical-smoke-2000-2001/factor_panel_manifest.json`
- preprocessing_summary: `reports/chapter3_factor_panel/run-chapter3-empirical-smoke-2000-2001/preprocessing_summary.csv`
- metrics_csv: `process/research/chapter3_empirical/run-chapter3-empirical-smoke-2000-2001/factor_metrics.csv`
- portfolio_plan: `process/research/chapter3_empirical/run-chapter3-empirical-smoke-2000-2001/MULTIFACTOR-ADMISSION-SUMMARY.json`
