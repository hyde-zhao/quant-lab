...
- run_id: `run-stage6-full-ch4-20260611`
- status: `PASS`
- provider_fetch: `0`
- lake_write: `0`
- catalog_publish: `0`
...
- fama_macbeth_results: `reports/stage6_full_run_20260611/chapter4_factor_models/run-stage6-full-ch4-20260611/fama_macbeth_results.csv`
- factor_model_returns: `reports/stage6_full_run_20260611/chapter4_factor_models/run-stage6-full-ch4-20260611/factor_model_returns.parquet`
- model_comparison: `reports/stage6_full_run_20260611/chapter4_factor_models/run-stage6-full-ch4-20260611/model_comparison.csv`
- factor_correlation: `reports/stage6_full_run_20260611/chapter4_factor_models/run-stage6-full-ch4-20260611/factor_correlation.csv`
- model_correlation: `reports/stage6_full_run_20260611/chapter4_factor_models/run-stage6-full-ch4-20260611/model_correlation.csv`
- model_admission_summary: `process/research/stage6_full_run_20260611/chapter4_factor_models/run-stage6-full-ch4-20260611/MODEL-ADMISSION-SUMMARY.json`
