...
import experiments.run_experiment_10 as experiment_10
import experiments.run_experiment_12 as experiment_12
...
def test_help_includes_market_data_alias_and_benchmark_path(capsys, monkeypatch):
    for module_name, parser_func in (
        ("run_experiment_10.py", experiment_10.parse_args),
        ("run_experiment_12.py", experiment_12.parse_args),
    ):
