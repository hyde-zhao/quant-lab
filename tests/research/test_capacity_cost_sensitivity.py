...
from experiments.run_factor_framework_exp15 import FactorFrameworkError
from experiments.run_multifactor_strategy_suite_exp17_21 import (
...
TARGET_FILES = (
    ...
    Path("experiments/run_multifactor_strategy_suite_exp17_21.py"),
)
...
def test_s07_forbidden_boundaries_are_static_and_no_secret_leakage() -> None:
    ...
    experiment_source = Path("experiments/run_multifactor_strategy_suite_exp17_21.py").read_text(encoding="utf-8")
