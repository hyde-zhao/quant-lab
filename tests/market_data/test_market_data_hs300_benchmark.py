...
from experiments.run_out_of_sample_overfit_risk_exp10 import apply_benchmark_metadata_experiment_10
from experiments.run_market_regime_segments_exp12 import apply_benchmark_metadata_experiment_12
...
def test_benchmark_and_experiment_import_boundaries():
    ...
    for source_path in (
        ...
        "experiments/run_out_of_sample_overfit_risk_exp10.py",
        "experiments/run_market_regime_segments_exp12.py",
    ):
